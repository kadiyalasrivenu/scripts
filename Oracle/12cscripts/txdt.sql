...
select  s.sid, s.username, t.start_time, r.name, KTIFPSTA, t.used_ublk, t.used_urec, t.status,
...
col start_time head "Start Time" form a17
col name head "Undo|Segment" form a22
...
select 	s.sid, s.username, s.osuser, t.start_time, r.name, 
