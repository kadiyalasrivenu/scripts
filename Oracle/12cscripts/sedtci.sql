...
col program head "Program" form a34
col module head "Module" form a34
...
select 	s.con_id, s.sid, s.serial#, p.pid, p.spid, s.osuser osuser,
	s.program, s.module, s.action, s.machine machine, s.username username
from 	v$session s,
	v$process p
...
col event head "Last Wait Event" form a28
