...
select	con_id, facility, severity, dest_id, error_code, 
...
select 	con_id, to_char(to_date(last_time_updated, 'mm/dd/yyyy hh24:mi:ss'), 'DD-MON HH24:MI:SS') ltu,
...
col parent_dbun head "DB Unique Name|of Parent" form a30
col dest_role head "Database Role" form a20
col current_scn head "SCN|Applied upto" form 99999999999999

select	con_id, db_unique_name, parent_dbun, 
	dest_role, current_scn
...
select	con_id, name, value, unit, time_computed, datum_time
...
select	con_id, to_char(START_TIME, 'DD-MON HH24:MI:SS') st,
...
col siz head "Total|Log|Size|MB" form 9,999
...
col pid head "Standby|OS|Process" form a8
...
select	con_id, thread#, sequence#, process, pid, status, client_process, client_pid, client_dbid,
