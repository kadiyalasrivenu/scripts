...
col concurrent_program_name head "Program" form a12
...
col start_date head "Start|Time" form a12
col start_delay head "Start|Delay" form 9999
col run_time head "Run|Time" form 999

SELECT p.node_name,r.request_id,cp.concurrent_program_name,u.user_name,
	 p.os_process_id cmos,to_char(actual_start_date,'dd-mon hh24:mi') start_date,
	 (actual_start_date-requested_start_date)*1440 start_delay,
	 (actual_completion_date-actual_start_date)*1440 run_time
