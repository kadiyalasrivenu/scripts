...
select 	substr(name,instr(name,'/',-1)+1) name, df.file#, 
	phyrds, readtim/100 readtim, (decode(readtim,0,1,readtim)*10)/decode(phyrds,0,1,phyrds) avgreadiotim, 
	maxiortm/100 maxiortm,
	phywrts, writetim/100 writetim, (decode(writetim,0,1,writetim)*10)/decode(phywrts,0,1,phywrts) avgwriteiotim, 
