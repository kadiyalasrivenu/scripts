...
select 	b.sql_id,
	...
	decode(b.ROW_LEVEL_SEC_MISMATCH,'Y','-ROW_LEVEL_SEC_MISMATCH-','')||
	...
	decode(b.SQL_REDIRECT_MISMATCH,'Y','-SQL redirection mismatch-','')||
	...
	decode(b.INCOMPLETE_CURSOR,'Y','-Cursor is incomplete-','')||
	...
	decode(b.ROW_SHIP_MISMATCH,'Y','-Session does not support row shipping-','')||
