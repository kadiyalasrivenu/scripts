...
col ie head "Ini|tial|Ext|ent|(MB)" form 9,999
col ne head "Next|Ext|ent|(MB)" form 9,999
...
col owner Head "Owner" form a10 trunc
col table_name head "Table Name" form a25 trunc
col column_name head "Column Name" form a22
...
col LAST_ANALYZED head "Last Analyzed" form a6
...
col HISTOGRAM head "Histogram" form a10
...
col owner Head "Owner" form a8 trunc
col table_name head "Table Name" form a25
col column_name head "Column Name" form a25
col LAST_ANALYZED head "Last Analyzed" form a6
col SAMPLE_SIZE head "Sample Size" form 999,999,999
...
col LIKE_PREDS  head "Like|Preds" form 99,999
col null_preds head "Null|Preds" form 99,999
col ts head "Timestamp" form a6
...
select 	cu.obj#, do.name, c.name cname,
	...
	to_char(cu.TIMESTAMP,'dd-mon') ts
