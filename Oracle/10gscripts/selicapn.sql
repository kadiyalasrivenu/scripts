...
col kglnaobj head "Object" form a50
col held head "Mode|Held" form a12
col req head "Mode|Requested" form a12
...
select s.sid,ob.kglnaobj,
	...
	decode(kglpnmod, 0, 'None', 1, 'Null', 2, 'Share', 3, 'Exclusive','Unknown') held,
	decode(kglpnreq, 0, 'None', 1, 'Null', 2, 'Share', 3, 'Exclusive','Unknown') req
from v$session s,x$kglpn pn,x$kglob ob
where s.saddr=pn.kglpnuse
and pn.kglpnhdl=ob.kglhdadr
and s.sid='&1'
order by 2,3
/