...
col qcsid head "Query|Coordinator|Sid" form 99999 
...
col esize head "Expe|cted|Size|(In KB)" form 9,999,999
col was head "Work Area|Size|(In KB)" form 9,999,999
col amem head "Actual|Size|(In KB)" form 9,999,999
col maxmem head "Max|Size|Used|(In KB)" form 9,999,999
