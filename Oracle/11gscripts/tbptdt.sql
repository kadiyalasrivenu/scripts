...
select	OWNER, TABLE_NAME, DEF_TABLESPACE_NAME, DEF_SEGMENT_CREATION, DEF_LOGGING, DEF_COMPRESSION, DEF_COMPRESS_FOR, IS_NESTED
...
select 	partition_position, partition_name, subpartition_count, LOGGING, 
