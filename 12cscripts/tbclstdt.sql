...
col low_val head "Low Value" form a30
col high_val head "High Value" form a30
...
col column_name head "Column Name" form a30
col endpoint_number head "End|Point|Number" form 999,999,999,999
col ENDPOINT_REPEAT_COUNT head "End|Point|Repeat Count" form 999,999
...
select 	dth.column_name, dth.endpoint_number, dth.ENDPOINT_REPEAT_COUNT,
	dth.endpoint_value, dth.endpoint_actual_value
from 	dba_tab_histograms 	dth,
	dba_tab_col_statistics	dtc
