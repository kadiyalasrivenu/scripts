...
col gets head "Gets" form 99999999
...
order	by to_number(substr(rs.segment_name,instr(segment_name,'_SYSSMU')+7,(instr(segment_name,'_',2))-(instr(segment_name,'_SYSSMU')+7)))
/
