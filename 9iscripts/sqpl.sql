...
REM create global temporary table sql_plan_temp_copy on commit preserve rows as select * from v$sql_plan where 1=2

delete 	from sql_plan_temp_copy
/


Insert 	into sql_plan_temp_copy
	select 	* 
	from 	v$sql_plan 
	where 	hash_value = &1
	and 	child_number = &2
...
col id form 99
col operation head "Operation" form a40 trunc
