...
column la heading "Analyzed|on" format a10

select  p.TABLE_OWNER, p.TABLE_NAME, p.PARTITION_NAME, t.SUBPARTITION_NAME, t.COLUMN_NAME, t.NUM_DISTINCT, t.DENSITY, 
	t.NUM_BUCKETS, t.NUM_NULLS, t.GLOBAL_STATS, t.USER_STATS, t.SAMPLE_SIZE, 
	to_char(t.last_analyzed,'dd-mon-yy') la
...
order	by p.TABLE_OWNER, p.TABLE_NAME, SUBPARTITION_POSITION
/
