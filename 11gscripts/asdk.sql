...
col cd head "Create Date" form a13
col md head "Mount Date" form a13
col path head "Path" form a40
col label head "Label" form a6
col library head "Library" form a6

select 	ad.GROUP_NUMBER, adg.NAME groupname, ad.DISK_NUMBER, ad.name diskname, 
	ad.PATH, 
	to_char(ad.create_date,'dd-mon-dd: HH24') cd, to_char(ad.mount_date,'dd-mon-dd: HH24') md,
	ad.label, ad.LIBRARY
from 	v$asm_disk 	ad, 
	v$asm_diskgroup adg
