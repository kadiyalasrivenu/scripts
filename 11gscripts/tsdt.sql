...
select 	tablespace_name, block_size/1024 block_size, (initial_extent/1048576) initial_extent,
...
select 	tablespace_name, bigfile, logging, FORCE_LOGGING, encrypted, compress_for, 
...
select 	TS#, name, FLASHBACK_ON, INCLUDED_IN_DATABASE_BACKUP, ENCRYPT_IN_BACKUP
from 	v$tablespace
where 	name=upper('&1')
order	by 1, 3
/
